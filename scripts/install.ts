...
(await import("../modules/iterm2/mod.ts")).default.install();
(await import("../modules/htop/mod.ts")).default.install();
(await import("../modules/ghq/mod.ts")).default.install();
await (await import("../modules/fonts/mod.ts")).default.install();
